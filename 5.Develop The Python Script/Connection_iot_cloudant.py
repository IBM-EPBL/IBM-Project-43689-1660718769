...
data=myData, qos=0, print("Published data Successfully: %s",
myData)
while True:
myData={'name': 'Train1', 'lat': 17.6387448, 'lon':
78.4754336)
pub (myData)
time.sleep (3)
#myData('name': 'Train2', 'lat': 17.6387448, 'lon':
78.4754336)
#pub (myData)
#time.sleep (3)
myData={'name': 'Train1', 'lat': 17.6341908, 'lon':
78.4744722)
pub (myData)
time.sleep(3)
...
pub (myData)
time.sleep (3)
myData={'name': 'Train1', 'lat': 17.6132382, 'lon':
78.4707318)
pub (myData)
time.sleep (3)
